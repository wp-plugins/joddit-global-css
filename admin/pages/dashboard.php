...
$jgcss_admin_pages->admin_header(
	'Dashboard',
	array('label' => 'Add New', 'url' => '/wp-admin/admin.php?page=jgcss_stylesheet'),
	array('name' => 'bulkaction', 'action' => '/wp-admin/admin.php?page=jgcss_dashboard&amp;bulkaction=1', 'method' => 'post', 'id' => 'bulkaction')
);
